...
class Line {
  ...
  draw() {
    ...
    if (window.innerWidth <= 1100) {
      ctx.strokeStyle = `rgba(75, 150, 120, ${1 - this.distance / 100})`;
    }
    if (window.innerWidth > 1100) {
      ctx.strokeStyle = `rgba(75, 150, 120, ${1 - this.distance / 300})`;
    }

    //ctx.strokeStyle = `rgba(75, 137, 220, ${1 - this.distance / 300})`;
    ctx.lineWidth = 1;
    ctx.stroke();
  }
}
